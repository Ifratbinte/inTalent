...
// const UpdateTalentProfile: React.FC<Props> = ({ userData }) => {
...
//       <div className="flex justify-center items-center section-gap-b w-45 h-52 bg-gray-100">
//         <TbCameraPlus className="w-16 h-16" />
//         {/* <img
...
//           <div className="mb-2">
//             <FieldTitle title="Talent category" />
//             <FormInputDropdown
//               control={control}
//               label={`${label ? label : ""}`}
//               name="category"
...
//             />
//           </div>
//           <FieldTitle title="Talent details" />
//           <CustomDatePicker
//             control={control}
//             name="dob"
//             label="Date of Birth"
...
//               <BaseButton
//                 btn_style="bg-[#e95f24] text-white"
